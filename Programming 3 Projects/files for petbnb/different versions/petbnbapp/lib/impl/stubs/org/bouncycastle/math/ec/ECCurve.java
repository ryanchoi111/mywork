...
public abstract class ECCurve {
	...
	public static class Fp {
		...
		public Fp(javabc.BigInteger q, javabc.BigInteger a, javabc.BigInteger b) {
		}
	...
	public static class F2m {
		 ...
		 *  <code>F<sub>2<sup>m</sup></sub></code>.
		 */
		public F2m(int m, int k, javabc.BigInteger a, javabc.BigInteger b) {
		}
		 ...
		 */
		public F2m(int m, int k, javabc.BigInteger a, javabc.BigInteger b, javabc.BigInteger n, javabc.BigInteger h) {
		}
		 ...
		 *  <code>F<sub>2<sup>m</sup></sub></code>.
		 */
		public F2m(int m, int k1, int k2, int k3, javabc.BigInteger a, javabc.BigInteger b) {
		}
		 ...
		 *  <code>#E<sub>a</sub>(F<sub>2<sup>m</sup></sub>) = h * n</code>.
		 */
		public F2m(int m, int k1, int k2, int k3, javabc.BigInteger a, javabc.BigInteger b, javabc.BigInteger n, javabc.BigInteger h) {
		}

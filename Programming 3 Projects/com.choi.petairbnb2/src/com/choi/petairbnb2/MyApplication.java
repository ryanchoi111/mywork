...
//        username.addActionListener(e -> mainc.name.set(username.getText()));
//        System.out.println(mainc.name.toString());
...
//        uib.bind(mainc.pw, pass);
//        Storage.getInstance().writeObject("MyContact", mainc);
//        Contact readContact = (Contact)Storage.getInstance().readObject("MyContact");
